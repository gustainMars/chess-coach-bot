...
def test_opening_name_from_url_basic():
    assert (
        _opening_name_from_url("https://www.chess.com/openings/Ruy-Lopez-Opening")
        == "Ruy Lopez Opening"
    )
...
def test_opening_name_from_url_stops_at_digit():
    assert (
        _opening_name_from_url("https://www.chess.com/openings/Sicilian-Defense-2.Nf3")
        == "Sicilian Defense"
    )


def test_opening_name_from_url_apostrophe():
    name = _opening_name_from_url(

...
from unittest.mock import patch, AsyncMock, MagicMock, patch
...
async def test_evaluate_deviation():
    ...
    with patch("bot.services.deviation.chess.engine.popen_uci", AsyncMock(return_value=(mock_transport, mock_engine))):
